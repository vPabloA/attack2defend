...
VALIDATION_FLAGS=(--require-public-sources --require-mapping-backbone --require-semantic-routes --min-nodes "80" --min-edges "60" --min-mapping-files "1")
...
echo "[3/4] Validating mapping-backbone bundle"
